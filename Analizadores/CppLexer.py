...
class CppLexer(Lexer):
    ...
    tokens = {
        ...
        PLUS, MINUS, TIMES, DIVIDE, MOD, ADDEQ, MINEQ, TIMESEQ, DIVIDEEQ, MODULEEQ, ASSIGN, EQUAL, NOT_EQUAL, LESS, LESS_EQUAL, # type: ignore
        GREATER, GREATER_EQUAL, AND, OR, NOT, SEMICOLON, COMMA, LEFT_PAREN,  # type: ignore
        RIGHT_PAREN, LEFT_BRACE, RIGHT_BRACE, # type: ignore
    }
